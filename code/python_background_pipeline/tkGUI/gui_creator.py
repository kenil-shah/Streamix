...
class GUI_Creator_temp:
    ...
    def defining_labels(self):
        # Title label
        self.title_label = ttk.Label(self.content, text="Video Enhancing Features")
    ...
    def defining_buttons(self):
        ...
        self.bg_select_button = ttk.Button(self.content, text="Select Virtual BG",
        ...
        self.stop_video_processing_button = ttk.Button(self.content, text="Stop processing",
                                                       command=self.stop_processing_video)
    ...
    def define_radio_buttons_for_method_select(self):
        self.raw_video = ttk.Radiobutton(self.content, text='Raw Video',
                                         variable=self.chosen_method, value='raw_video')
        self.virtual_bg = ttk.Radiobutton(self.content, text='Virtual Background',
                                       variable=self.chosen_method, value='virtual_bg')
    ...
    def defining_geometry_grid(self):
        ...
        self.bg_select_button.grid(column=4, row=2, columnspan=2, sticky=(N, W))
