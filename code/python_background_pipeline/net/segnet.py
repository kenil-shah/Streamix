...
class ERD_SegNet(nn.Module):
    ...
    def __init__(self, classes=2):
        ...
        self.stage2_down = conv_bn_act(
            48, classes, kernel_size=3, stride=1, padding=1)
        ...
        self.stage1_down = conv_bn_act(
            24, classes, kernel_size=3, stride=1, padding=1)
        ...
        self.stage0_down = conv_bn_act(
            12, classes, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, input):
        ...
        input_cascade1 = nn.AvgPool2d(3, stride=2, padding=1)(input)
        input_cascade2 = nn.AvgPool2d(3, stride=2, padding=1)(input_cascade1)
        input_cascade3 = nn.AvgPool2d(3, stride=2, padding=1)(input_cascade2)
        input_cascade4 = nn.AvgPool2d(3, stride=2, padding=1)(input_cascade3)
